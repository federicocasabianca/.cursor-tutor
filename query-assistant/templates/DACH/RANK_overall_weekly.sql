...
-- Use this query to track weekly evolution of search metrics
-- =========================
DECLARE tz STRING DEFAULT 'Europe/Madrid';
DECLARE START_DATE DATE DEFAULT '2025-09-01';        -- <-- ajusta ventana
...
FROM sessions
WHERE world = 'de'
GROUP BY week_start_date, platform, world
ORDER BY week_start_date, platform, world
