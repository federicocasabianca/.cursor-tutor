...
## Entradas
- **Nodos:** ["more_materials","better_choice","more_orders","happy_sellers"]
- **Transiciones:** [
  "upload_frequency -> more_materials",
  "more_materials -> better_choice",
  "higher_quality -> better_choice",
  "diversity -> better_choice",
  "freshness -> better_choice",
  "purchase_frequency -> more_orders",
  "0_to_1_conversion -> more_orders",
  "higher_royalties -> happy_sellers",
  "recognition_followers -> happy_sellers"
]
- **Lado:** ambos
- **Mercado:** DE
- **Outcome global:** gmv_per_session
